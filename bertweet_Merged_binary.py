...
df = pd.read_csv('Merged_binaryclass.csv')
X = df['tweet']
y = df['class']
...
for epoch in range(num_epochs):
    ...
    if val_accuracy > best_val_accuracy:
        ...
        torch.save(model.state_dict(), 'best_model_bertweet_Merged_binary.pt')


# Load the best model checkpoint for testing
model.load_state_dict(torch.load('best_model_bertweet_Merged_binary.pt'))
...
print("\n------------------------------")
print("BerTweet - Merged Binary Class")
print("------------------------------\n")
